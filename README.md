...
**Keywords:** _bloom filter, cuckoo filter, HyperLogLog, MinHash, Top-K, probabilistic data-structures, XOR-Filter._
...
- `merge(other: CountMinSketch) -> CountMinSketch`: merge occurrences of two sketches.
